...
func (m *SchedulerDeactivateScheduleParamsBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SchedulerDeactivateScheduleParamsBody) validateBlocks(formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) validateProvider(formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) validateTimezone(formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) contextValidateBlocks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) contextValidateProvider(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) contextValidateTimezone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchedulerDeactivateScheduleParamsBody) UnmarshalBinary(b []byte) error {
	var res SchedulerDeactivateScheduleParamsBody
