...
func (m *SchedulerStateResponse) validateState(formats strfmt.Registry) error {
...
func (m *SchedulerStateResponse) validateStates(formats strfmt.Registry) error {
...
func (m *SchedulerStateResponse) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchedulerStateResponse) contextValidateStates(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SchedulerStateResponse) UnmarshalBinary(b []byte) error {
	var res SchedulerStateResponse
