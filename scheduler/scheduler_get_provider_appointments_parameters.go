...
// WithAppointmentCountry adds the appointmentCountry to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentCountry(appointmentCountry *string) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentCountry(appointmentCountry)
	return o
}

// SetAppointmentCountry adds the appointmentCountry to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentCountry(appointmentCountry *string) {
...
// WithAppointmentLanguage adds the appointmentLanguage to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentLanguage(appointmentLanguage *string) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentLanguage(appointmentLanguage)
	return o
}

// SetAppointmentLanguage adds the appointmentLanguage to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentLanguage(appointmentLanguage *string) {
...
// WithAppointmentPadding adds the appointmentPadding to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentPadding(appointmentPadding *bool) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentPadding(appointmentPadding)
	return o
}

// SetAppointmentPadding adds the appointmentPadding to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentPadding(appointmentPadding *bool) {
...
// WithAppointmentPending adds the appointmentPending to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentPending(appointmentPending *bool) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentPending(appointmentPending)
	return o
}

// SetAppointmentPending adds the appointmentPending to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentPending(appointmentPending *bool) {
...
// WithAppointmentServiceConfigDurations adds the appointmentServiceConfigDurations to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentServiceConfigDurations(appointmentServiceConfigDurations []int32) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentServiceConfigDurations(appointmentServiceConfigDurations)
	return o
}

// SetAppointmentServiceConfigDurations adds the appointmentServiceConfigDurations to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentServiceConfigDurations(appointmentServiceConfigDurations []int32) {
	o.AppointmentServiceConfigDurations = appointmentServiceConfigDurations
}

// WithAppointmentServiceConfigFixedDuration adds the appointmentServiceConfigFixedDuration to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentServiceConfigFixedDuration(appointmentServiceConfigFixedDuration *int32) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentServiceConfigFixedDuration(appointmentServiceConfigFixedDuration)
	return o
}

// SetAppointmentServiceConfigFixedDuration adds the appointmentServiceConfigFixedDuration to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentServiceConfigFixedDuration(appointmentServiceConfigFixedDuration *int32) {
...
// WithAppointmentState adds the appointmentState to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentState(appointmentState *string) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentState(appointmentState)
	return o
}

// SetAppointmentState adds the appointmentState to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentState(appointmentState *string) {
	o.AppointmentState = appointmentState
}

// WithAppointmentStatus adds the appointmentStatus to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentStatus(appointmentStatus *string) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentStatus(appointmentStatus)
	return o
}

// SetAppointmentStatus adds the appointmentStatus to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentStatus(appointmentStatus *string) {
...
// WithAppointmentUnavailable adds the appointmentUnavailable to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) WithAppointmentUnavailable(appointmentUnavailable *bool) *SchedulerGetProviderAppointmentsParams {
	o.SetAppointmentUnavailable(appointmentUnavailable)
	return o
}

// SetAppointmentUnavailable adds the appointmentUnavailable to the scheduler get provider appointments params
func (o *SchedulerGetProviderAppointmentsParams) SetAppointmentUnavailable(appointmentUnavailable *bool) {
...
// bindParamSchedulerGetProviderAppointments binds the parameter appointment.service.config.durations
func (o *SchedulerGetProviderAppointmentsParams) bindParamAppointmentServiceConfigDurations(formats strfmt.Registry) []string {
